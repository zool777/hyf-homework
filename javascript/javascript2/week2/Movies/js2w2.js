...
const newNumbers = numbers
  ...
  .map((number) => number * 2);
console.log("The doubled odd numbers are", newNumbers);
...
const movies1980s = movies.filter(
  (movie) => movie.year >= 1980 && movie.year <= 1989
);
console.log(`Number of movies made between 1980-1989: ${movies1980s.length}`);
...
const totalMovies = filteredMovies.map((movie) => movie.title).length;
